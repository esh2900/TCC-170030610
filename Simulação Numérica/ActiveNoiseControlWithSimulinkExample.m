...
% Design a real-time active noise control system using a Speedgoat Simulink
% Real-Time target.
...
% This principle has been applied successfully to a wide variety of applications,
% such as noise-cancelling headphones, active sound design in car interiors,
% and noise reduction in ventilation conduits and ventilated enclosures.
%
...
% simulated acoustic path by the <docid:xpc_io_ref#bt521yi Speedgoat> and
% its IO104 analog module. The Speedgoat is an external Real-Time target
% for Simulink, which allows us to execute our model in real time and
% observe any data of interest, such as the adaptive filter coefficients,
% in real time.
%
...
% <<../mic1_anc.png>>
%
% The difference is only 2 or 3 samples, so using our current active
...
% of the Simulink model (the Speedgoat latency is set to 1 or 2 samples,
...
%
% K.-C. Chen, C.-Y. Chang, and S. M. Kuo, <https://iopscience.iop.org/article/10.1088/1757-899X/237/1/012015 "Active noise control in a duct to cancel broadband noise,"> in IOP Conference Series: Materials Science and Engineering, vol. 237, no. 1, 2017.
%
% <docid:xpc_io_ref#bt521yi Speedgoat real-time target for Simulink>
%
...
%
% See also:
% <https://www.mathworks.com/help/audio/examples/active-noise-control-using-a-filtered-x-lms-fir-adaptive-filter.html
